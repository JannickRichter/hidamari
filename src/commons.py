...
CONFIG_KEY_IS_PERIODIC = "is_periodic"
CONFIG_KEY_DATA_SOURCE_TIME = "data_source_time"
CONFIG_KEY_TIMES = "times"
CONFIG_TEMPLATE = {
    CONFIG_KEY_VERSION: CONFIG_VERSION,
    CONFIG_KEY_MODE: MODE_NULL,
    CONFIG_KEY_DATA_SOURCE: None,
    CONFIG_KEY_DATA_SOURCE_TIME: {"morning": "your-video.mp4", "afternoon": "your-video.mp4", "night": "your-video.mp4"},
    CONFIG_KEY_TIMES: {"morning": 4, "afternoon": 12, "night": 20},
    CONFIG_KEY_IS_PERIODIC: False,
